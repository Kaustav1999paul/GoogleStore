    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddNewProductButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadingBar.setMessage("We are adding the google phone");
    ...
    private void StoreProductInformation(final String imageURL, final String description, final String pname, final String price) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child("Products").child("Phones").child(ProductRandomKey).exists())){
                    ...
                    RootRef.child("Phones").child(ProductRandomKey).updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(AddNewProductActivity.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                            }else {
                                loadingBar.dismiss();
                                String mess = task.getException().toString();
                                Toast.makeText(AddNewProductActivity.this, "Error: " + mess, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
